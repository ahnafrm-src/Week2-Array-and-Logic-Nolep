...
function dataHandling (argumen) {
    ...
    for(let b = 0; b < argumen.length; b++) {
       console.log(`Nomor ID: ${argumen[b][0]}`)
       console.log(`Nama lengkap: ${argumen[b][1]}`)
       console.log(`TTL: ${argumen[b][2]} ${argumen[b][3]}`)

       console.log(`hobi: ${argumen[b][4]}`)
       console.log("")
    }
}
